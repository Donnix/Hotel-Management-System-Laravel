...
@section('content')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" name="nama_kamar" id="nama_kamar">
                    ...
                    <option value="{{$kamar->nama_kamar}}" @if($transaction->nama_kamar == $kamar->nama_kamar)selected @endif>{{$kamar->nama_kamar}}</option>
                    @endforeach
                </select>
            </div>
        </div>
 ...
 <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" value="{{$transaction->jumlah_kamar}}"name="jumlah_kamar" class="form-control" placeholder=" Masukan jumlah kamar">
            </div>
        </div>
     ...
     <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Total </strong>
                <input type="text" value="{{$transaction->total}}"name="total" class="form-control" placeholder=" Masukan Total ">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Bayar </strong>
                <input type="text" value="{{$transaction->bayar}}"name="bayar" class="form-control" placeholder=" Masukan Bayar ">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" value="{{$transaction->kembalian}}"name="kembalian" class="form-control" placeholder=" Masukan kembalian  ">
            </div>
        </div>
